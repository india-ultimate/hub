  ...
  return (
    <div class={clsx(!props.padding && "px-8 lg:px-10", props.class)}>
      ...
      <textarea
        {...textAreaProps}
        class={clsx(
          "h-28 w-full rounded-2xl border-2 bg-white p-5 outline-none placeholder:text-slate-300 md:h-36 md:text-lg lg:h-40 lg:px-6 lg:text-xl dark:bg-gray-900 dark:placeholder:text-slate-700",
          props.error
