...
const purchaseMembership = (playerId, year, setStatus, setPlayerById) => {
  console.log(`Paying for membership for ${playerId} for ${year}`);
      ...
      >
        ...
        <div class="my-2">
          ...
          <button
            ...
            onclick={e =>
              purchaseMembership(player()?.id, year(), setStatus, setPlayerById)
            }
          >
            Pay
          </button>
