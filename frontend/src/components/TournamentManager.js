                        ...
                        <Switch>
                          <Match when={match.status === "YTF"}>
                            <button
                              ...
                              className="text-white bg-blue-700 hover:bg-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 mb-5 disabled:dark:bg-gray-400"
                            >
                              Update
                            </button>
                          </Match>
                          <Match when={match.status === "SCH"}>
                            ...
                            <button
                              ...
                              className="text-white bg-green-700 hover:bg-green-800 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 mb-5 disabled:dark:bg-gray-400"
                            >
                              Update
                            </button>
                          </Match>
