  ...
  return (
    ...
    >
      <div class="space-y-8">
        <Field
          name="scored_by_id"
          validate={required("Please add the player who scored.")}
        >
          {(field, fieldProps) => (
            <Select
              {...fieldProps}
        ...
        <Field
          name="assisted_by_id"
          validate={required("Please add the player who assisted.")}
        >
          {(field, fieldProps) => (
            <Select
              {...fieldProps}
        ...
        <button
          type="submit"
          class="mb-2 w-full rounded-lg bg-blue-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 disabled:bg-gray-400 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 sm:w-auto"
          disabled={createMatchStatsEventMutation.isLoading}
        >
          Submit
        </button>
        <Show when={error()}>
