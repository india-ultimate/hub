  ...
  return (
    <div class={clsx(!props.padding && "px-8 lg:px-10", props.class)}>
      ...
      <input
        {...inputProps}
        class={clsx(
          "h-14 w-full rounded-2xl border-2 bg-white px-5 outline-none placeholder:text-slate-300 dark:bg-gray-900 md:h-16 md:text-lg lg:h-[70px] lg:px-6 lg:text-xl",
          props.error
